...
/*
public class ConnectionsAdapterOri extends RecyclerView.Adapter<ConnectionsAdapterOri.ViewHolder> {
    private List<ConnectionListModel> mConnectionsModels;
    private Activity mActivity;


    public ConnectionsAdapterOri(Activity activity, List<ConnectionListModel> connectionsModels) {
