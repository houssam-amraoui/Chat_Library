...
/*public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        switch (viewType) {
                ...
                if (message.isMessageFile()){
                    ...
                    if (!message.isFileUploaded()){
                        ...
                        message.getMessageFile().getFileInBackground((file, e) -> {
                            ...
                            QuickHelp.getMessageImage(file.getAbsolutePath(), holder.mImageMsg);
            ...
            case CHAT_IN:
                ...
                if (message.getMessageOnList() != null && !message.getMessageOnList().isRead() && message.getMessageOnList().getUserTo().equals(User.getUser())){

                    message.getMessageOnList().setRead(true);
                    message.getMessageOnList().resetCount();
                    message.getMessageOnList().saveInBackground();
                }
    ...
    public void updateMessage(MessageModel newMessage) {
        ...
        for (int i = 0; i < arraySize; i++) {
            ...
            if (message != null && message.getObjectId().equals(newMessage.getObjectId())) {
