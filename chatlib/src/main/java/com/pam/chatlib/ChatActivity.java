...
public class ChatActivity extends AppCompatActivity {
    ...
    ImageButton mSend;
    ImageView mPickFile, mTooBarFavorite, mTooBarVideoCall;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSend.setOnClickListener(v -> ChatActivity.this.sendMessage());
        mTooBarVideoCall.setOnClickListener(v -> QuickActions.CallUser(this, mUser));
    ...
    private void setupLiveQuery() {
        ...
        liveQueryChatSubscription.handleEvent(SubscriptionHandling.Event.CREATE, (query, message) -> {
            ...
            if (message.getSenderAuthor().equals(mCurrentUser)){
    ...
    public void sendMessageFile(String imagePath){
        ...
        Bitmap imageBitmap = QuickHelp.getBitmapFromPath(imagePath);
        ...
        if (imageBitmap != null) {
            ...
            file.saveInBackground((SaveCallback) e -> {
                ...
                if (e == null){
                    ...
                    message.saveEventually(e1 -> {
                        if (e1 == null){

                            mChatAdapter.updateMessage(message);
                            setMessageList(message, ConnectionListModel.MESSAGE_TYPE_IMAGE);
        ...
        if (mEditText.getText() != null && mEditText.getText().length() > 0){
            ...
            message.saveEventually(e -> {
                if (e == null){
                    ...
                    mChatAdapter.updateMessage(message);
                    setMessageList(message, ConnectionListModel.MESSAGE_TYPE_CHAT);
                }
            });
    ...
    public void setMessageList(MessageModel message, String type){
            ...
            query.whereEqualTo(ConnectionListModel.COL_USER_TO, mUser);
            ...
            query.getFirstInBackground((messagerListClass, e) -> {
                ...
                if (e == null){
                    ...
                    messagerListClass.setUserTo(mUser);
                    messagerListClass.setUserFromId(mCurrentUser.getObjectId());
                    messagerListClass.setUserToId(mUser.getObjectId());
                    ...
                    query1.whereEqualTo(ConnectionListModel.COL_USER_FROM, mUser);
                    ...
                    query1.getFirstInBackground((lastMessage, e1) -> {
                        ...
                        if (e1 == null){
                            ...
                            lastMessage.setUserTo(mUser);
                            lastMessage.setUserFromId(mCurrentUser.getObjectId());
                            lastMessage.setUserToId(mUser.getObjectId());
                            ...
                            messageList.setUserTo(mUser);
                            messageList.setUserFromId(mCurrentUser.getObjectId());
                            messageList.setUserToId(mUser.getObjectId());
