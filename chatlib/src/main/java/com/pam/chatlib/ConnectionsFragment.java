...
public class ConnectionsFragment extends Fragment {
    ...
    private LinearLayout mConnectionLayout, mChatsLayout, mOnlineLayout, mVistsLayout, mLikesLayout, mFavoritesLayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        expansionHeader = v.findViewById(R.id.expansionHeader);
        expansionLayout = v.findViewById(R.id.expansionLayout);

        mConnectionLayout  = v.findViewById(R.id.connections_layout);
    ...
    private void hideLoading(boolean isLoaded, String title, String description, int errorImage){
    ...
    private void initializeDropDown(){
        ...
        expansionLayout.addListener((expansionLayout, expanded) -> {
            ...
            if (expanded){
                ...
                mTitleHeader.setText(Application.getInstance().getString(R.string.connection_all_connections));
        ...
        mChatsLayout.setOnClickListener(v -> {
            ...
            mTitleHeader.setText(Application.getInstance().getString(R.string.connection_chats));
        ...
        mOnlineLayout.setOnClickListener(v -> {
            ...
            expansionLayout.toggle(true);
            mTitleHeader.setText(Application.getInstance().getString(R.string.connection_online));
        ...
        mVistsLayout.setOnClickListener(v -> {
            ...
            expansionLayout.toggle(true);
            mTitleHeader.setText(Application.getInstance().getString(R.string.connection_visits));
        ...
        mFavoritesLayout.setOnClickListener(v -> {
            ...
            clearHeader = true;
            expansionLayout.toggle(true);
            mTitleHeader.setText(Application.getInstance().getString(R.string.connection_favorites));
        ...
        messageQuery.findInBackground((messages,e) -> {
            ...
            if (e == null) {
                ...
                if (messages.size() > 0){
                    ...
                    if (isUnique && isAdded()) hideLoading(false, getString(R.string.no_connection_yet), getString(R.string.no_chat_yet_explain), R.drawable.ic_tabbar_mess);
                }
                ...
                if (isUnique && isAdded()) hideLoading(false, getString(R.string.not_internet_connection), getString(R.string.settings_no_inte), R.drawable.ic_blocker_large_connection_grey1);

            } else {

                if (isUnique && isAdded()) hideLoading(false, e.getLocalizedMessage(), getString(R.string.error_ocurred), R.drawable.ic_close);
            }
        ...
        messageQuery.findInBackground((messages,e) -> {
            ...
            if (e == null) {
                ...
                if (messages.size() > 0){
                    ...
                    if (isUnique && isAdded()){
                        hideLoading(false, getString(R.string.no_chat_yet), getString(R.string.no_chat_yet_explain), R.drawable.ic_tabbar_mess);
                    }
                }
                ...
                if (isUnique && isAdded()){
                    hideLoading(false, getString(R.string.not_internet_connection), getString(R.string.settings_no_inte), R.drawable.ic_blocker_large_connection_grey1);
                }

            } else {

                if (isUnique && isAdded()){
                    hideLoading(false, e.getLocalizedMessage(), getString(R.string.error_ocurred), R.drawable.ic_close);
                }
            }
        ...
        visitorModelParseQuery.findInBackground((visitors, e) -> {
            ...
            if (e == null){
                ...
                if (visitors.size() > 0){
                    ...
                    if (isUnique){
                        hideLoading(false, getString(R.string.no_visit_yet), getString(R.string.no_visit_yet_explain), R.drawable.ic_navigation_bar_visible);
                    }
                }
        ...
        query.findInBackground((favorites, e) -> {
            ...
            if (e == null){
                ...
                if (favorites.size() > 0){
                    ...
                    if (isUnique){
                        hideLoading(false, getString(R.string.no_favorite_yet), getString(R.string.no_favorite_yet_explain), R.drawable.ic_profile_favorite);
                    }
